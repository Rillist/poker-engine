...
var tableParseInt = function(table, base) {
    for (var i = 0; i < table.length; i++) {
        table[i] = parseInt(table[i], base || 10);
    }
    return table;
};
...
var load = function(data) {
    ...
    // parse int
    table.game.smallBlind = parseInt(table.game.smallBlind, 10);
    table.game.bigBlind = parseInt(table.game.bigBlind, 10);
    table.game.pot = parseInt(table.game.pot, 10);
